...
/**
 * @ngdoc function
 * @name ubr.counter.activities:CounterActivitiesController
 * @description
 * # CounterActivitiesController
 * Controller of the ubr counter activities module.
 */
angular
  .module('ubr.counter.activities')
  .controller('CounterActivitiesController', CounterActivitiesController);

/* @ngInject */
function CounterActivitiesController (counterService, DateRange, $rootScope, $scope) {
  var controller = this;
  ...
  controller.search = function () {
    ...
    var showSearchResults = function (pagedActivities) {
      controller.activities = pagedActivities.member;
      controller.totalActivities = pagedActivities.totalItems;
   ...
   */
  // Move this to the result controller!!!
